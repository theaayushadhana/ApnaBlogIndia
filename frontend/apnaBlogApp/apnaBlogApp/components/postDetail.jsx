...
//   useEffect(() => {
//     // https://api.apnablogapp.com/api/posts/${slug}
...
//     // axios.get(`http://localhost:5000/api/posts/${slug}/comments`)
//     //   .then(response => {
...
//   //   e.preventDefault();
//   //   try {
//   //     const response = await axios.post(`http://localhost:5000/api/posts/${slug}/comments`, { 
//   //       content: newComment, 
